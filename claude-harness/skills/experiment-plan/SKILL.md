...
description: "Turn a refined research proposal into a claim-driven experiment roadmap — ablation matrix, evaluation protocol, run order, compute budget. Use after `research-refine`, or when user says \"experiment plan\", \"실험 설계\", \"어떤 실험을 해야\", \"evaluation protocol\", \"实验方案\"."
