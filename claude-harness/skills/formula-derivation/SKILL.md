...
description: Structure and derive research formulas — build a theory line, organize assumptions, turn scattered equations into a paper-ready derivation. Use when user says "derive this", "수식 정리", "유도해줘", "推导公式", "where does this equation come from".
