---
name: run-experiment
description: The front door for running an ML experiment — picks the target and hands off to the provider skill. Use when user says "run experiment", "deploy to server", "학습 돌려줘", "跑实验".
