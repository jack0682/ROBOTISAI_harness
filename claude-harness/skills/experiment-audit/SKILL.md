...
description: "Audit experiment integrity before claiming results — fake ground truth, score normalization, phantom results, insufficient scope. Use when user says \"审计实验\", \"check experiment integrity\", \"audit results\", \"实验诚实度\"."
