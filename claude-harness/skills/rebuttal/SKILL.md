---
name: rebuttal
description: "Answer external reviews: parse them, enforce coverage and grounding, draft a text-only rebuttal under venue limits. Use when user says \"rebuttal\", \"reply to reviewers\", \"ICML rebuttal\", \"OpenReview response\"."
