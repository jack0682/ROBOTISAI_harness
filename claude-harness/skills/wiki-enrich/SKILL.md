---
name: wiki-enrich
description: "Fill in the TODO sections of research-wiki paper pages that an ingest left as bare scaffolds. Use when user says 'enrich wiki', 'fill paper TODOs', 'wiki body 補完', '把 paper 摘要寫進 wiki', 'research-wiki 自動填', or after a batch ingest that left papers/ as TODO scaffolds."
