---
name: proof-checker
description: Verify a mathematical proof, find its gaps via cross-model review, fix each with full derivations, and re-review. Use when user says "检查证明", "verify proof", "proof check", "审证明", "check this proof", or wants rigorous mathematical verification of a theory paper.
