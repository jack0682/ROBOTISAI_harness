---
name: vast-gpu
description: "The Vast.ai provider — rent, manage and destroy GPU instances. Normally reached through `/run-experiment`; call it directly for instance lifecycle work. Use when user says \"rent gpu\", \"vast.ai\", \"GPU 빌려\", \"rent a server\", \"destroy the instance\"."
