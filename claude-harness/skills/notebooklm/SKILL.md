---
name: notebooklm
description: Google NotebookLM through its API — create notebooks, add sources, generate every artifact type, download. Activates on /notebooklm or intent like \"create a podcast about X\".
---
