...
description: Hugging Face Hub operations via the `hf` CLI: download and upload models, datasets and spaces, create repos, manage cache, run compute jobs. Use when user says "huggingface", "hf cli", "모델 다운로드", "push to the hub", "허깅페이스".
---
