...
description: "The whole research lifecycle end to end: idea discovery → experiment bridge → auto review → paper writing. Use when user says \"全流程\", \"full pipeline\", \"从找idea到投稿\", \"end-to-end research\"."
