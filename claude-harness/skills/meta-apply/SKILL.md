---
name: meta-apply
description: "Land approved meta-optimize patches — the only skill permitted to modify the skill corpus, behind a cross-model jury and human approval. Use when the user says \"meta apply\", \"/meta-apply\", \"land the staged patches\", \"应用优化\", after a /meta-optimize run."
