---
name: proof-writer
description: Write rigorous proofs for ML/AI theory — prove a theorem, lemma or proposition, fill missing steps, formalize a sketch. Use when user says "prove this", "증명해줘", "증명 써줘", "补全证明", "写证明", "证明某个命题". For checking an existing proof, use `proof-checker`.
