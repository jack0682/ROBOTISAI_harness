---
name: meta-optimize
description: "Analyse usage logs and propose optimizations to SKILL.md files, reviewer prompts and workflow defaults. Use when user says \"优化技能\", \"meta optimize\", \"improve skills\", \"分析使用记录\"."
