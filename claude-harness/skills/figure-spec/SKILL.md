---
name: figure-spec
description: "Deterministic, editable SVG architecture and pipeline diagrams from structured JSON. Preferred over AI illustration for formal figures. Use when user says \"架构图\", \"workflow 图\", \"pipeline 图\", \"确定性矢量图\", \"figure spec\", \"draw architecture\"."
