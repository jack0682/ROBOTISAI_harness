...
description: Analyzes CSV files, generates summary stats, and plots quick visualizations using Python and pandas. Use when user says "summarize this csv", "csv 요약", "describe the data", "기술통계", "quick plot of this table".
metadata:
  version: 2.1.0
