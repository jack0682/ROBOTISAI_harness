...
2. **Research wiki ingest no-op (2026-04-21).** `/research-wiki init`
   ...
   ("optional and automatic"). (`/alphaxiv` and `/deepxiv` have since been
   retired; their names stay here because this is the record of what existed
   that day, not a list of what to call.)
