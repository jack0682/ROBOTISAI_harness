...
description: SSH job queue for multi-seed/multi-config runs, with OOM-aware retry. Use when user says "batch experiments", "队列实验", "run grid", "multi-seed sweep", "auto-chain experiments".
