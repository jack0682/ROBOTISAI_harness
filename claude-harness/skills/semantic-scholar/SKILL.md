...
description: Search published venue papers (IEEE, ACM, Springer) with citation counts and TLDR — complements /arxiv. Use when user says "search semantic scholar", "find IEEE papers", "find journal papers", "venue papers", "citation search".
