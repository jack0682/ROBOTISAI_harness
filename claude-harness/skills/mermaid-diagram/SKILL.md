...
description: Generate verified Mermaid diagrams into figures/ — flowcharts, sequence, class, ER, Gantt and more. Use when user says "mermaid", "flowchart", "순서도", "시퀀스 다이어그램", "流程图".
