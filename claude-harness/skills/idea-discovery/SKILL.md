---
name: idea-discovery
description: "Broad research direction → validated, pilot-tested ideas, chaining literature survey, generation, novelty check and review. Use when user says \"找idea全流程\", \"idea discovery pipeline\", \"从零开始找方向\"."
