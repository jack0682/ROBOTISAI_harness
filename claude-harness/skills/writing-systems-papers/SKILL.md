...
description: "Paragraph-level structural blueprint for 10-12 page systems papers — page allocation, paragraph templates, writing patterns. Use when user says \"写系统论文\", \"systems paper structure\", \"OSDI paper\", \"SOSP paper\"."
