---
name: research-wiki
description: "Persistent knowledge base accumulating papers, ideas, experiments and claims across the research lifecycle. Use when user says \"知识库\", \"research wiki\", \"add paper\", \"wiki query\", \"查知识库\"."
...
`/semantic-scholar`, `/exa-search`) use the
...
Other skills (`/research-lit`, `/arxiv`, `/semantic-scholar`,
`/exa-search`) call the same helper directly in
