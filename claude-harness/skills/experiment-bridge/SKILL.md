...
description: "Turn EXPERIMENT_PLAN.md into running code: implement, deploy to GPU, collect first results. Use when user says \"实现实验\", \"implement experiments\", \"bridge\", \"从计划到跑实验\", \"deploy the plan\"."
