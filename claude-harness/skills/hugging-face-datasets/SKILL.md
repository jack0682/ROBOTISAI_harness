...
description: Create and manage datasets on Hugging Face Hub: init repos, define configs, stream row updates, query with SQL. Use when user says "dataset repo", "데이터셋 올려", "publish a dataset", "query the dataset with SQL".
---
