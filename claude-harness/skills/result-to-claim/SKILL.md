...
description: Judge what completed experiments actually support, what they don't, and what evidence is still missing; route to pivot, supplement, or confirm. Use when user says "what does this result mean", "결과 해석", "이 실험이 뭘 보여주는지", "can I claim this", "这个结果说明什么".
