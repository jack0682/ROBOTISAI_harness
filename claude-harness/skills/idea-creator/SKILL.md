...
Local specialization: the reviewer here judges **ideas**, not a finished
artifact, so the prompt carries the idea list and the ranking criteria rather
than file paths. Reviewer independence still holds — send the criteria, never a
Claude-side preference among the ideas.
