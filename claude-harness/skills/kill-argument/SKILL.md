---
name: kill-argument
description: "Two-thread adversarial review: one fresh reviewer writes the strongest rejection memo, a second defends point-by-point and surfaces what is still unresolved. Use when user says \"kill argument\", \"adversarial review\", \"hostile review\", \"rebuttal preparation\", \"reviewer-2 simulation\"."
