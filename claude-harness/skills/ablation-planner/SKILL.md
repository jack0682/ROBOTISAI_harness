...
description: Design ablations from a reviewer's perspective once main results pass result-to-claim, then check feasibility and implement. Use when user says "ablation", "어블레이션", "which component matters", "어느 부분이 기여했는지", "消融实验".
