...
description: "Check every number, comparison and scope claim in the paper against the raw result files, with a zero-context reviewer. Use when user says \"审查论文数据\", \"check paper claims\", \"verify numbers\", \"论文数字核对\"."
